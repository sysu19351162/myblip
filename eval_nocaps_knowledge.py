...
def main(args, config):
    ...
    val_dataset, test_dataset = create_dataset('nocaps_knowledge', config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/nocaps_knowledge.yaml')
    parser.add_argument('--output_dir', default='output/NoCaps_knowledge')
