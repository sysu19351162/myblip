...
entity_file_path = "/mnt/data/yangzhenbang/BLIP/annotation/coco_karpathy_train.json"
...
# entity_file_path = "/mnt/data/yangzhenbang/BLIP/annotation/coco_karpathy_val.json"
...
# entity_file_path = "/mnt/data/yangzhenbang/BLIP/annotation/coco_karpathy_test.json"
# visual_concept_path = '/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/coco_test_visual_concept.json'

#
# print("nocaps val processing")
# entity_file_path='/mnt/data/yangzhenbang/BLIP/annotation/nocaps_val.json'
# visual_concept_path = '/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/nocaps_val_visual_concept.json'
# print("nocaps test processing")
# entity_file_path='/mnt/data/yangzhenbang/BLIP/annotation/nocaps_test.json'
# visual_concept_path = '/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/nocaps_test_visual_concept.json'
...
#for i in tqdm(range(2)):
    ...
    # print(i)
    entity_set = []
    image_id = entity[i]["image"]
    # image_id, sep, tail = image_id.partition('#')
    # image_id = 'flickr30k-images/'+
    # print(image_id)
    visual_concept_list = []

    visual_concept_list.extend(visual_concept[image_id])
...
#nocaps
# json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/nocaps_val_has_knowledge.json", 'w'))
# json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/nocaps_test_has_knowledge.json", 'w'))

#coco
json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/coco_caption_train_has_knowledge.json", 'w'))
# json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/coco_caption_val_has_knowledge.json", 'w'))
# json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/coco_caption_test_has_knowledge.json", 'w'))
