...
#####读取数据###########
print('Visual Genome')
path='/data2/datasets/cc3m/cc3m_new.json'

with open(path,'r',encoding='utf8')as fp:
    json_data = json.load(fp).values()
...
with open("/mnt/data/yangzhenbang/datasets/blip_caption/cc3m_entity.json", 'w', encoding='utf-8') as fw:
