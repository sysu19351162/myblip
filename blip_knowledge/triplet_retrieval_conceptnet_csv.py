...
df = pd.read_csv(csv_path,chunksize=10000,header=None,iterator=True)
    ...
    for idx,instance in enumerate(vcs):#对每个instance搜索knowledge
        ...
        for k  in vg_knowledge:
            if vg_knowledge_str =='':
                ...
                vg_knowledge_str = vg_knowledge_str+','+k
        chunk[idx]['conceptnet_knowledge'] = conceptnet_knowledge_str
        chunk[idx]['vg_knowledge'] = vg_knowledge_str
