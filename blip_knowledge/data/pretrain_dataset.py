...
class pretrain_knowledge_dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for i in  random.sample(self.img_knowledge_pretrain[ann['image_id']]['knowledge_conceptnet'], knowledge_num):
            knowledge_conceptnet_image += i
            knowledge_conceptnet_image += ','
        knowledge_conceptnet_image = pre_caption(knowledge_conceptnet_image,self.max_words)
