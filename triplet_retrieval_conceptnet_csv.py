...
# entity_file_path = "/mnt/data/yangzhenbang/datasets/blip_caption/coco_val_entity.json"
...
# entity_file_path = "/mnt/data/yangzhenbang/datasets/blip_caption/coco_test_entity.json"
...
csv_path = '/data1/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/vg_example_visual_concept.csv'
# print("vg processing")
...
df = pd.read_csv(csv_path,chunksize=1,iterator=True)
...
#for i in tqdm(range(2)):
    ...
    # print(i)
    vcs = chunk['images']
    chunk['conceptnet_knowledge'] = ''
    chunk['vg_knowledge'] = ''
    all_conceptnet_knowledge = []
    all_vg_knowledge = []
    for idx,instance in enumerate(vcs):#对每个instance搜索knowledge
        # entity_set = instance.split(',')
        ...
        all_conceptnet_knowledge.append(conceptnet_knowledge)
        all_vg_knowledge.append(vg_knowledge)
        # print(type(entity[i]))
        # conceptnet_knowledge_str = ''
        # for k  in conceptnet_knowledge:
        #     if conceptnet_knowledge_str =='':
        #         conceptnet_knowledge_str = conceptnet_knowledge_str+k
        #     else:
        #         conceptnet_knowledge_str = conceptnet_knowledge_str+','+k
        #
        # vg_knowledge_str = ''
        # for k  in vg_knowledge:
        #     if vg_knowledge_str =='':
        #         vg_knowledge_str = vg_knowledge_str+k
        #     else:
        #         vg_knowledge_str = vg_knowledge_str+','+k
        # chunk.loc[idx,'conceptnet_knowledge'] = conceptnet_knowledge
        # chunk.loc[idx,'vg_knowledge'] = vg_knowledge_str
    ...
    chunk['conceptnet_knowledge'] = all_conceptnet_knowledge
    chunk['vg_knowledge'] = all_vg_knowledge
    # print(chunk)
    if flag:
...
#coco
# json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/coco_train_has_knowledge.json", 'w'))
# json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/coco_val_has_knowledge.json", 'w'))
# json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/coco_test_has_knowledge.json", 'w'))
...
#example
# json.dump(entity, open("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/example_has_knowledge.json", 'w'))
result.to_csv("/mnt/data/yangzhenbang/datasets/blip_caption/data_coco_vg_flickr/kg_data/vg_knowledge_example.csv", index=None)
print(result)
print(chunk.columns.values)